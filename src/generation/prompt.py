...
from src.ingestion.dataset import DATASET_AS_OF
...
def render_prompt(
    question: str, chunks: list[Document], dataset_as_of: str = DATASET_AS_OF
) -> str:
    ...
    Args:
        ...
        dataset_as_of (str): the Code civil corpus's snapshot date, shown to
            the user when no retrieved Chunk answers the question
    ...
    return template.render(question=question, chunks=chunks, dataset_as_of=dataset_as_of)
